...
const Signup = () => {
    ...
    return (
        <Container minH="100vh" alignItems="center" justifyContent="center" centerContent>
            ...
            <Input name='email' placeholder='Email' focusBorderColor="black" value={form.email} onChange={handleChange} />
            <Input name='fullname' placeholder='Nama Lengkap' marginTop="5px" focusBorderColor="black" onChange={handleChange} />

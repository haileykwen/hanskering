...
const Signup = () => {
    ...
    return (
        <Container minH="100vh" alignItems="center" justifyContent="center" centerContent>
            <Heading marginBottom="20px" lineHeight="100%">Buat akun dan mulai checkout sepatu-sepatu keren!</Heading>
            ...
            <InputGroup marginTop="5px" focusBorderColor="black">
                ...
                />
                <InputRightElement width="4.5rem">
                    <Button h='1.75rem' size='xs' onClick={handleClick2} _focus={{outlineColor: "black"}}>
                        {show2 ? 'Tutup' : 'Lihat'}
                    </Button>
                </InputRightElement>
            </InputGroup>
